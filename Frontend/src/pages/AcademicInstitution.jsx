                      ...
                      <div key={data.month} className="bar-chart-item">
                        <div 
                          ...
                          style={{ 
                            ...
                            height: `${(data.certificates / 1500) * 100}%`
                          }} 
                        />
                        <span className="bar-value">{data.certificates}</span>
                ...
                <div className="analytics-card">
                  ...
                  <div className="pie-chart-container">
                    {analytics.departments.map((dept, index) => (
                      <div key={dept.name} className="pie-item">
                        <div 
                          className="pie-color" 
                ...
                <div className="analytics-card">
                  ...
                  <div className="activity-list">
                    ...
                    <div className="activity-item">
                      ...
                      <span>New certificate issued to Alice Johnson</span>
                      <small>4 hours ago</small>
                    </div>
                    <div className="activity-item">
                      <CloudArrowUpIcon className="w-5 h-5 text-purple-400" />
                      <span>Bulk upload completed - 25 certificates</span>
