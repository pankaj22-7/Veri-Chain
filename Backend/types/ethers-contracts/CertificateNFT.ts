...
export declare namespace CertificateNFT {
    ...
    export type CertificateStruct = {studentName: string, degreeName: string, issueDate: BigNumberish}

    export type CertificateStructOutput = [studentName: string, degreeName: string, issueDate: bigint] & {studentName: string, degreeName: string, issueDate: bigint }
  
    }

  export interface CertificateNFTInterface extends Interface {
    getFunction(nameOrSignature: "approve" | "balanceOf" | "getApproved" | "getCertificateDetails" | "isApprovedForAll" | "issueCertificate" | "name" | "owner" | "ownerOf" | "renounceOwnership" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenURI" | "transferFrom" | "transferOwnership"): FunctionFragment;
...
encodeFunctionData(functionFragment: 'issueCertificate', values: [AddressLike, string, string]): string;
...
decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    getCertificateDetails: TypedContractMethod<
      [tokenId: BigNumberish, ],
      [CertificateNFT.CertificateStructOutput],
      'view'
    >
    ...
    issueCertificate: TypedContractMethod<
      [student: AddressLike, studentName: string, degreeName: string, ],
      [void],
      'nonpayable'
    >
